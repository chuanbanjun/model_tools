...
tfidf = tfidftransformer.fit_transform(vectorizer.fit_transform(train_content)) #向量化，再用tfidf调整
...
bst.save_model('output/1-xgb.model')
# dump model
...
try:
    print (metrics.accuracy_score(np.array(test[1]), preds))
except:
    pass
try:
    print (metrics.precision_score(np.array(test[1]), preds))
except:
    pass
try:
    print (metrics.f1_score(np.array(test[1]), preds))
except:
    pass
try:
    print (metrics.recall_score(np.array(test[1]), preds))
except:
    pass
try:
    print (metrics.roc_auc_score(np.array(test[1]), preds))
except:
    pass
